    ...
    return (
        <>
            <div className="flex h-screen w-full flex-col md:flex-row">
                ...
                <div className="md:basis-2/3 p-4 bg-orange-100 flex justify-center items-center">
                ...
                <div className="md:basis-1/3 px-4 md:py-10 py-4 bg-blue-100 flex justify-center">
