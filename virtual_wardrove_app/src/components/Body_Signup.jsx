...
const Body_Signup = () => {
    ...
    return (
        <>
            <div className="flex min-h-full w-full flex-col items-center md:gap-10 gap-6">
                <input 
                    type="text"
                    placeholder={translations[language].login_placeholderemail}
                ...
                > 
                    {translations[language].login_goback}
                </button>
